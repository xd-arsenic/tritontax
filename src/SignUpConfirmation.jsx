...
export default function SignUpConfirmation() {
  ...
  return (
    ...
    >
      ...
      {/* CONTENT SECTION */}
      <section className="mx-auto max-w-3xl px-6 pt-20 pb-20 relative z-10">
        <div className="text-center">
          {/* Success Icon */}
          <div className="mb-8 flex justify-center">
            <div className="w-20 h-20 rounded-full bg-[#3C431E] flex items-center justify-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-[#39281D] mb-6 sm:text-5xl" style={{ lineHeight: '1.2' }}>
            Submission Received!
          </h1>
          
          <p className="text-lg text-[#39281D] opacity-75 mb-4" style={{ lineHeight: '1.6' }}>
            Thank you for your interest in volunteering with Triton Tax.
          </p>
          
          <p className="text-base text-[#39281D] opacity-75 mb-8" style={{ lineHeight: '1.6' }}>
            We've received your submission and will contact you within 48 hours.
          </p>

          <p className="text-lg text-[#39281D] mb-8 font-medium" style={{ lineHeight: '1.6' }}>
            In the meantime, you can start your training!
          </p>
          ...
          <div className="flex justify-center">
            <Link
              to="/volunteer-resources"
              className="inline-block rounded-full bg-[#3C431E] px-8 py-4 text-base font-semibold text-white text-center transition-colors hover:bg-[#2d3416]"
              style={{ boxShadow: '0 3px 12px rgba(60, 67, 30, 0.35), 0 1px 4px rgba(60, 67, 30, 0.25)' }}
            >
              Start Training
            </Link>
          </div>
